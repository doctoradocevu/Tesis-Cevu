...
\glsxtrnewsymbol
[description={Norma euclidiana}]% options
{norma_euclidiana}% label
{\ensuremath{\left\|\cdot \right\|^2 }}% symbol

\glsxtrnewsymbol
[description={Norma $\ell_1$}]% options
{norma_L1}% label
{\ensuremath{\left\|\cdot \right\|_1 }}% symbol